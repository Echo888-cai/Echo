...
import { comparisonCandidates, looksLikeCompareQuestion, planCompare } from "../src/server/services/agentPlanner.js";
...
check("英文 ticker：RKLB vs ASTS 命中", looksLikeCompareQuestion("RKLB vs ASTS 哪个赔率更好"));
check("英文 vs 正确拆成两个标的", JSON.stringify(comparisonCandidates("RKLB vs ASTS 哪个赔率更好")) === JSON.stringify(["RKLB", "ASTS"]));
