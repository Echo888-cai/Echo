...
> **⚠️ 2026-07-02 起，接力入口改为 [`docs/MASTER_PLAN_2026-07-02.md`](./MASTER_PLAN_2026-07-02.md)**——
> 那里有最新的全面评审（产品/交互/架构/商业化四维评分）、问题清单（UX-x/ARCH-x/FEAT-x 编号+验收标准）、
> P0-P8 分阶段执行计划与状态跟踪表。本文件保留作背景资料（2026-06-22 时点的架构与约束仍然有效）。
