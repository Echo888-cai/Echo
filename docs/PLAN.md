...
| B-2~B-7 | 财报趋势/公司对比/风险去占位符/港股估值口径/filings 覆盖/web 证据非沙箱实测 | ⬜ | B 研究质量深化主线，B-1 之后逐个推进 |
