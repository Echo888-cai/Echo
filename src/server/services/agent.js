/**
 * Research agent — the heart of the reliability layer.
 *
 * Pipeline (Phase-1):
...
import { parseUserContext, applyUserContextToMemory } from "./userContext.js";
...
function persistSession(result, profile, { question, userContext: _userContext, repaired: _repaired, sessionId, sessionTitle, conversationId, history, userId = "local" }) {
  try {
