/**
 * Company identity resolution and data-completeness rules.
 */
...
export async function verifyUsTicker(ticker) {
  let rows;
...
export async function suggestUsTickers(query) {
...
export function computeDataHealth(company) {
