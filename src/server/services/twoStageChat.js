...
纪律：
- 当前研究主体以"当前研究对象"和已接入数据为准，不要从历史里翻出**别的**旧公司当成本轮新主题。
- 但要**承接上文**：若问题是对当前公司的追问（"它的竞对是谁""那利润率呢""第二个呢"），结合上文理解它在问什么、指代谁，给出连贯的回答角度，不要当成无上下文的孤立问题。
- 若问题里的代码疑似拼错、近似或非标准，且用户要求买卖/加减仓动作，先标注"需澄清实体"，不要猜。
- 若问题用"这只/那只/它/这个"等指代词，结合上文仍指向不明时，才标注"指代不明，需澄清"。
