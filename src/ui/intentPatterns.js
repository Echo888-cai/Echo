...
const SCREEN_COND = /(PE|PB|市盈率|市净率|市值|股息率?|分红率?|价格|营收增速|增速)\s*(?:(小于|大于|低于|高于|超过|不到|少于|多于|以上|以下|<|>|≤|≥|＜|＞)|[0-9]+(?:\.[0-9]+)?\s*(?:万亿|千亿|百亿|亿|万|元|美元|港元|%|％)?\s*(小于|大于|低于|高于|超过|不到|少于|多于|以上|以下|<|>|≤|≥|＜|＞))/i;
