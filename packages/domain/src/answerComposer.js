...
const RESEARCH_INTENTS = researchIntents;
...
function mergeEvidenceIntoPanel(panel, webEvidence) {
 ...
 */
function buildReportPrompt(question, panel, dataSources = {}, context = {}) {
  const profile = companyByTicker(panel.ticker) || {};
...
return {
  researchReplyFromPanel,
  normalizeResearchAnswer,
  buildChatPrompt,
  mergeEvidenceIntoPanel,
  buildReportPrompt
};
}
